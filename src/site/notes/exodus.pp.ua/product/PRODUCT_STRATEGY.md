---
{"tags":["domain:product","status:canonical","format:spec"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"PRODUCT_STRATEGY","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/product/PRODUCT_STRATEGY/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/manifesto/MANIFESTO\|MANIFESTO]] — продуктова реалізація ідеологічних принципів "Everything is an Agent"

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — технічні аксіоми як фундамент продукту
- [[exodus.pp.ua/architecture/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — "агент" як core product entity
- [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — Proposal system як ключова UX диференціація ("AI, який пропонує — людина, яка вирішує")

**Від цього документа залежать:**
- [[exodus.pp.ua/PROJECT_DESCRIPTION_CANONICAL\|PROJECT_DESCRIPTION_CANONICAL]] — технічний опис тієї самої системи (повна узгодженість)
...
- **RUNTIME_ARCHITECTURE_INDEX.md** — master index архітектурних документів
- **PROPOSAL_SYSTEM_V1.md** — деталі Proposal lifecycle
