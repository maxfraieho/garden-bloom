---
{"tags":["domain:agent","status:canonical","format:spec","feature:logic"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"AGENT_LOGIC_VERSIONING_V1","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/AGENT_LOGIC_VERSIONING_V1/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Розташування:** `docs/architecture/AGENT_LOGIC_VERSIONING_V1.md`  
**Мова:** Українська (технічна)  
**Залежить від:** `docs/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1.md` (v1.1.0+)
...
Монорепозиторій `garden-bloom-memory` (визначений в AGENT_MEMORY_GIT_DIFFMEM_V1.md) розширюється:
...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — аксіома A2 (logic-update — завжди через Proposal, завжди human review)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL\|STORAGE_AUTHORITY_MODEL_CANONICAL]] — logic/ storage tier у git monorepo (§1, Tier 3)
...
- [[exodus.pp.ua/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1\|AGENT_MEMORY_GIT_DIFFMEM_V1]] — суміжний storage tier у тому самому git monorepo
