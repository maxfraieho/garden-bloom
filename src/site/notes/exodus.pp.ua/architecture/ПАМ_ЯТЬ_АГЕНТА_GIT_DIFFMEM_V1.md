---
{"tags":["domain:agent","status:canonical","format:spec","feature:memory"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — аксіома A7 (bounded memory, git monorepo, HARD limits), частина A1 (git monorepo як source of truth)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]] — git monorepo як storage tier (§1, Tier 1 та Tier 2)
...
- [[exodus.pp.ua/architecture/АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ\|АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ]] — Task Definition Step 1: завантаження Layer 1
- [[exodus.pp.ua/architecture/КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ\|КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ]] — Phase 3 (Context Load): memory Layer 1 via Gateway
- [[exodus.pp.ua/architecture/ВЕРСІОНУВАННЯ_ЛОГІКИ_АГЕНТА_V1\|ВЕРСІОНУВАННЯ_ЛОГІКИ_АГЕНТА_V1]] — суміжний storage tier у тому самому git monorepo
