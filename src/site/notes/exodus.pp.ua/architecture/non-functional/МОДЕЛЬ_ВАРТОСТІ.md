---
{"tags":["domain:arch","status:canonical","format:spec","feature:execution"],"created":"2026-02-22","updated":"2026-02-22","tier":1,"title":"МОДЕЛЬ ВАРТОСТІ","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/non-functional/МОДЕЛЬ_ВАРТОСТІ/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — A4 (replaceable orchestration), component roles
- [[exodus.pp.ua/architecture/historical/АРХІТЕКТУРНА_БАЗА_СИСТЕМИ\|АРХІТЕКТУРНА_БАЗА_СИСТЕМИ]] — §9 Infrastructure cost baseline (historical snapshot)
- [[exodus.pp.ua/architecture/non-functional/МОДЕЛЬ_МАСШТАБУВАННЯ\|МОДЕЛЬ_МАСШТАБУВАННЯ]] — cost at different design points

**Цей документ впливає на:**
- Architectural decisions про вибір vendor components
- [[ПРОДУКТОВА_СТРАТЕГІЯ\|ПРОДУКТОВА_СТРАТЕГІЯ]] → бізнес-модель та pricing
