---
{"tags":["domain:meta","status:canonical","format:spec","feature:graph"],"created":"2026-02-21","updated":"2026-02-21","tier":2,"title":"ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ/","dgPassFrontmatter":true,"noteIcon":""}
---
...
Інваріанти — не дублювання [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]]. Вони — **операційна перевірка**: "яку конкретну фразу в новому документі `semantic-guard` має вважати порушенням?"
...
EXCEPTION: АУДІО_ПРОМПТ_NOTEBOOKLM.md (зафіксовано як навмисно ізольований)
```
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — операціоналізує аксіоми A1–A7 у верифіковані правила
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — аксіоми як первинне джерело всіх архітектурних інваріантів
...
- [[exodus.pp.ua/architecture/КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ\|КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ]] — tag system invariants (§5)
- [[exodus.pp.ua/architecture/КАНОНІЗАЦІЯ_МОВИ\|КАНОНІЗАЦІЯ_МОВИ]] — мовні норми (I-Term2)
