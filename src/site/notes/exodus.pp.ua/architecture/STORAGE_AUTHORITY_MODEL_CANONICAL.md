---
{"tags":["domain:storage","status:canonical","format:spec","feature:storage"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"STORAGE_AUTHORITY_MODEL_CANONICAL","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — аксіоми A1 (storage authority), A5 (gateway entrypoint), A6 (frontend isolation)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1\|AGENT_MEMORY_GIT_DIFFMEM_V1]] — git monorepo як окремий storage tier (memory/, logic/)
- [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — proposal lifecycle визначає transitions статусів

**Від цього документа залежать:**
- [[exodus.pp.ua/architecture/EXECUTION_PIPELINE_CANONICAL\|EXECUTION_PIPELINE_CANONICAL]] — хто що пише на кожній фазі pipeline
- [[exodus.pp.ua/architecture/RUNTIME_ARCHITECTURE_CANONICAL\|RUNTIME_ARCHITECTURE_CANONICAL]] — загальна authority model
- [[exodus.pp.ua/architecture/ORCHESTRATION_LAYER_ABSTRACTION\|ORCHESTRATION_LAYER_ABSTRACTION]] — Hatchet wrapper як status writer
- [[exodus.pp.ua/architecture/RUN_LIFECYCLE_CANONICAL\|RUN_LIFECYCLE_CANONICAL]] — status.json writer contract
