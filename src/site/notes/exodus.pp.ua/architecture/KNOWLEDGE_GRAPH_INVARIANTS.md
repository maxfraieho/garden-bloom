---
{"tags":["domain:meta","status:canonical","format:spec","feature:graph"],"created":"2026-02-21","updated":"2026-02-21","tier":2,"title":"KNOWLEDGE_GRAPH_INVARIANTS","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/KNOWLEDGE_GRAPH_INVARIANTS/","dgPassFrontmatter":true,"noteIcon":""}
---
...
Інваріанти — не дублювання [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]]. Вони — **операційна перевірка**: "яку конкретну фразу в новому документі `semantic-guard` має вважати порушенням?"

---

## 1. Структурні інваріанти графу

### I-S1: Tier 1 документ мусить мати "Семантичні зв'язки"

```
RULE: кожен документ із tier:1 у frontmatter АБО у docs/INDEX.md Tier 1 списку
      ПОВИНЕН мати секцію "## Семантичні зв'язки" або "## Пов'язані нотатки"
VIOLATION: відсутня секція
SEVERITY: MEDIUM
AGENT: graph-linter
...
EXCEPTION: NOTEBOOKLM_AUDIO_PROMPT.md (зафіксовано як навмисно ізольований)
```
...
RULE: якщо новий документ класифікований як tier:1,
      GRAPH_MAP.md ПОВИНЕН бути оновлений з новим рядком у таблиці §1
VIOLATION: новий Tier 1 файл є, GRAPH_MAP.md не містить його ID
SEVERITY: MEDIUM
...
SOURCE: ARCHITECTURE_ROOT.md §Axiom A5
...
SEVERITY: CRITICAL
AGENT: semantic-guard
SOURCE: ARCHITECTURE_ROOT.md §Axiom A2
PROPOSAL: propose-contradiction-flag
```
...
SEVERITY: HIGH
AGENT: semantic-guard
SOURCE: ARCHITECTURE_ROOT.md §Axiom A3
PROPOSAL: propose-contradiction-flag
```
...
SEVERITY: CRITICAL
AGENT: semantic-guard
SOURCE: ARCHITECTURE_ROOT.md §Axiom A1
PROPOSAL: propose-contradiction-flag
```
...
RULE: якщо frontmatter містить feature:X,
      ...
      (mapping визначений у TAGGING_SYSTEM_CANONICAL.md §8.1)
VIOLATION: feature:proposal є, [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] відсутній
SEVERITY: LOW
AGENT: tag-auditor
...
SEVERITY: MEDIUM
AGENT: semantic-guard
SOURCE: ARCHITECTURE_ROOT.md §7 Термінологічне уточнення
...
SEVERITY: LOW
AGENT: semantic-guard
SOURCE: LANGUAGE_CANONICALIZATION.md
...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — операціоналізує аксіоми A1–A7 у верифіковані правила
- [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — proposal lifecycle інваріанти (§3)
- [[exodus.pp.ua/architecture/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — agent contract інваріанти (§4)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — аксіоми як первинне джерело всіх архітектурних інваріантів
- [[INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — canonical proposal statuses
- [[exodus.pp.ua/architecture/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — canonical agent activation rules
- [[exodus.pp.ua/architecture/TAGGING_SYSTEM_CANONICAL\|TAGGING_SYSTEM_CANONICAL]] — tag system invariants (§5)
- [[exodus.pp.ua/architecture/LANGUAGE_CANONICALIZATION\|LANGUAGE_CANONICALIZATION]] — мовні норми (I-Term2)
