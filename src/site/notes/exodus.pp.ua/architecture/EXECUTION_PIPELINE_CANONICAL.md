---
{"tags":["domain:execution","status:canonical","format:spec","feature:execution","feature:orchestration"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"EXECUTION_PIPELINE_CANONICAL","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/EXECUTION_PIPELINE_CANONICAL/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — §5 Canonical Flow: цей документ є його повним розкриттям

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/ORCHESTRATION_LAYER_ABSTRACTION\|ORCHESTRATION_LAYER_ABSTRACTION]] — Hatchet виконує кроки pipeline
- [[exodus.pp.ua/architecture/RUN_LIFECYCLE_CANONICAL\|RUN_LIFECYCLE_CANONICAL]] — state transitions прив'язані до фаз pipeline
- [[exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL\|STORAGE_AUTHORITY_MODEL_CANONICAL]] — write authority на кожній фазі
- [[exodus.pp.ua/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1\|AGENT_MEMORY_GIT_DIFFMEM_V1]] — Phase 3: завантаження memory Layer 1
...
- [[exodus.pp.ua/architecture/RUNTIME_ARCHITECTURE_CANONICAL\|RUNTIME_ARCHITECTURE_CANONICAL]] — pipeline є серцевиною runtime архітектури
