---
{"tags":["domain:meta","status:canonical","format:inventory","feature:graph"],"created":"2026-02-21","updated":"2026-02-21","tier":2,"title":"КАРТА_ГРАФУ","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/КАРТА_ГРАФУ/","dgPassFrontmatter":true,"noteIcon":""}
---
...
| ID | Файл | Домен | Хаб? |
|----|------|-------|-------|
| A1 | `architecture/АРХІТЕКТУРНИЙ_КОРІНЬ.md` | Meta | ★★★ (центральний хаб) |
| A2 | `architecture/КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ.md` | Execution | ★★ |
| A3 | `architecture/КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ.md` | Execution | ★ |
| A4 | `architecture/КАНОНІЧНИЙ_ЦИКЛ_ЗАПУСКУ.md` | Execution | ★ |
| A5 | `architecture/АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ.md` | Execution | ★ |
| A6 | `architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА.md` | Storage | ★★ |
| A7 | `architecture/КОНТРАКТ_АГЕНТА_V1.md` | Agent | ★★ |
| A8 | `architecture/ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1.md` | Agent | ★ |
| A9 | `architecture/ВЕРСІОНУВАННЯ_ЛОГІКИ_АГЕНТА_V1.md` | Agent | ★ |
...
| A13 | `architecture/КАНОНІЗАЦІЯ_МОВИ.md` | Meta | leaf |
| A14 | `backend/КОНТРАКТИ_API_V1.md` | API | ★ |
| A15 | `architecture/КАНОНІЧНИЙ_МЕТОД_МУЛЬТИАГЕНТНОЇ_РОЗРОБКИ.md` | Governance | ★★ |
| A16 | `architecture/РОЛЬ_ОРКЕСТРАТОРА.md` | Governance | leaf |
| M1 | `manifesto/МАНІФЕСТ.md` | Philosophy | ★ |
| M2 | `manifesto/ФІЛОСОФІЯ_ВСЕ_Є_АГЕНТОМ.md` | Philosophy | leaf |
| M3 | `manifesto/ГЛОСАРІЙ.md` | Philosophy | ★ |
| P1 | `PROJECT_DESCRIPTION_CANONICAL.md` | Meta | leaf |
| P2 | `product/СТРАТЕГІЯ_ПРОДУКТУ.md` | Product | leaf |

### Tier 2 — Допоміжні документи (витяги та implementation guides)

| ID | Файл | Домен | Відношення до Tier 1 |
|----|------|-------|----------------------|
| S1 | `architecture/СИСТЕМА_PROPOSAL_V1.md` | Mutation | Витяг з A10 (frontend-oriented) |
| S2 | `architecture/INBOX_ТА_ЦИКЛ_ЗАПУСКУ_V1.md` | Execution | Витяг з A10 + A4 (frontend-oriented) |
| S3 | `architecture/АРХІТЕКТУРНА_БАЗА_СИСТЕМИ.md` | Meta | Historical snapshot (2026-02-14) |
| S4 | `architecture/ІНДЕКС_АРХІТЕКТУРИ_ВИКОНАННЯ.md` | Meta | Master index |
| S5 | `architecture/АРХІТЕКТУРНИЙ_АУДИТ_ТА_УЗГОДЖЕНІСТЬ_ФІНАЛЬНИЙ.md` | Meta | Архівний аудит |
| S6 | `architecture/ІНВЕНТАР_ДОКУМЕНТАЦІЇ.md` | Meta | Інвентар документів |
| F1 | `frontend/LOVABLE_УЗГОДЖЕННЯ_З_АРХІТЕКТУРОЮ_ВИКОНАННЯ.md` | Frontend | Контракт Lovable |
| F2 | `frontend/ДИРЕКТИВА_УЗГОДЖЕННЯ_FRONTEND_V1.md` | Frontend | Директива для Lovable |
| F3 | `frontend/ПЛАН_МІГРАЦІЇ_FRONTEND_V1.md` | Frontend | Міграційний план |
| D1 | `drakon/ДОСЛІДЖЕННЯ_DRAKONWIDGET.md` | DRAKON | Дослідження бібліотеки |
| D2 | `drakon/СТРАТЕГІЯ_ІНТЕГРАЦІЇ.md` | DRAKON | Стратегія інтеграції |
| D3 | `drakon/АГЕНТНИЙ_ПРОМПТ_LOVABLE.md` | DRAKON | Prompt для реалізації |
| D4 | `drakon/ЧЕКЛИСТ_РЕАЛІЗАЦІЇ.md` | DRAKON | Чеклист |
| D5 | `drakon/АНАЛІЗ_ПРОЕКТУ.md` | DRAKON | Аналіз проекту |
| D6 | `drakon/ВИБІР_НАВИЧОК_CLAUDE.md` | DRAKON | Вибір skills |
| X1 | `ІНДЕКС.md` | Meta | Єдина точка входу |
| X2 | `АУДІО_ПРОМПТ_NOTEBOOKLM.md` | Meta | Operational prompt |
| ADR1 | `architecture/ADR_ФЕДЕРАТИВНА_СИСТЕМА_КОМЕНТАРІВ.md` | Architecture | ADR (2026-01-16) |
| M4 | `manifesto/МАНІФЕСТ_РОЗШИРЕНИЙ.md` | Philosophy | leaf |
| P3 | `product/МОДЕЛЬ_ДОСТУПУ.md` | Product | leaf |
...
| КАНОНІЗАЦІЯ_МОВИ.md — відсутні посилання | Додано "Пов'язані нотатки" |
| Відсутній КАРТА_ГРАФУ.md | Створено цей документ |
| PROJECT_DESCRIPTION_CANONICAL.md — відсутні "Семантичні зв'язки" | Додано секцію |
| СТРАТЕГІЯ_ПРОДУКТУ.md — відсутні "Семантичні зв'язки" | Додано секцію |
| КОНТРАКТИ_API_V1.md — лише неформальний "Div. також" | Додано "Семантичні зв'язки" секцію |
| INDEX.md — КАРТА_ГРАФУ.md не згадано | Додано посилання у Tier 2 та intro |
| АРХІТЕКТУРНИЙ_КОРІНЬ.md §Семантичні зв'язки — не посилається на GRAPH_MAP | Додано рядок |
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — §6 Semantic Map є початковою точкою графу
...
- [[exodus.pp.ua/architecture/ІНВЕНТАР_ДОКУМЕНТАЦІЇ\|ІНВЕНТАР_ДОКУМЕНТАЦІЇ]] — inventory статус кожного вузла
