---
{"title":"TAGGING_SYSTEM_CANONICAL","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/TAGGING_SYSTEM_CANONICAL/","dgPassFrontmatter":true,"noteIcon":""}
---
...
# Canonical version: docs/architecture/TAGGING_SYSTEM_CANONICAL.md
...
**Симптом**: документ позначений `feature:proposal`, але не має [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] у "Семантичні зв'язки".
...
|-----|---------------------|
| `feature:proposal` | [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] |
| `feature:storage` | [[exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL\|STORAGE_AUTHORITY_MODEL_CANONICAL]] |
| `feature:execution` | [[exodus.pp.ua/architecture/EXECUTION_PIPELINE_CANONICAL\|EXECUTION_PIPELINE_CANONICAL]] |
| `feature:memory` | [[exodus.pp.ua/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1\|AGENT_MEMORY_GIT_DIFFMEM_V1]] |
| `feature:logic` | [[exodus.pp.ua/architecture/DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА\|DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА]] |
| `feature:orchestration` | [[exodus.pp.ua/architecture/ORCHESTRATION_LAYER_ABSTRACTION\|ORCHESTRATION_LAYER_ABSTRACTION]] |
| `feature:auth` | [[exodus.pp.ua/architecture/БЕЗПЕКА_СИСТЕМИ\|БЕЗПЕКА_СИСТЕМИ]] |
| `feature:graph` | [[exodus.pp.ua/architecture/GRAPH_MAP\|GRAPH_MAP]] |
...
{
  "ARCHITECTURE_ROOT": {
    "file": "docs/architecture/ARCHITECTURE_ROOT.md",
...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — операційна норма для системи знань (мовна + структурна)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/LANGUAGE_CANONICALIZATION\|LANGUAGE_CANONICALIZATION]] — тег-ідентифікатори є винятком EN у UA-документах
- [[exodus.pp.ua/architecture/GRAPH_MAP\|GRAPH_MAP]] — кластери knowledge graph відображаються у `domain:*` тегах
- [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — governance через proposal lifecycle

**Від цього документа залежать:**
- [[exodus.pp.ua/architecture/KNOWLEDGE_GRAPH_INVARIANTS\|KNOWLEDGE_GRAPH_INVARIANTS]] — інваріанти включають правила тегування
