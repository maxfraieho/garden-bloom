---
{"tags":["domain:agent","status:canonical","format:spec","feature:memory"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"AGENT_MEMORY_GIT_DIFFMEM_V1","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Розташування:** `docs/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1.md`  
...
**Дії:**
- Публікація цього документу як канонічного (`docs/architecture/AGENT_MEMORY_GIT_DIFFMEM_V1.md`).
...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — аксіома A7 (bounded memory, git monorepo, HARD limits), частина A1 (git monorepo як source of truth)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL\|STORAGE_AUTHORITY_MODEL_CANONICAL]] — git monorepo як storage tier (§1, Tier 1 та Tier 2)
- [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — memory-update Proposal: єдиний механізм запису у memory/

**Від цього документа залежать:**
- [[exodus.pp.ua/architecture/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — §1.3 memory constraint, §6.4 memory format
- [[exodus.pp.ua/architecture/ORCHESTRATION_LAYER_ABSTRACTION\|ORCHESTRATION_LAYER_ABSTRACTION]] — Task Definition Step 1: завантаження Layer 1
- [[exodus.pp.ua/architecture/EXECUTION_PIPELINE_CANONICAL\|EXECUTION_PIPELINE_CANONICAL]] — Phase 3 (Context Load): memory Layer 1 via Gateway
- [[exodus.pp.ua/architecture/AGENT_LOGIC_VERSIONING_V1\|AGENT_LOGIC_VERSIONING_V1]] — суміжний storage tier у тому самому git monorepo
