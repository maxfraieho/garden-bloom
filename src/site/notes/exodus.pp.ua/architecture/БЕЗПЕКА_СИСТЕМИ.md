---
{"tags":["domain:security","status:canonical","format:spec","feature:auth"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"БЕЗПЕКА_СИСТЕМИ","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/БЕЗПЕКА_СИСТЕМИ/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — Axiom A2 (Мутація вимагає згоди) та A5 (Gateway = єдина точка входу)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — `safe_outputs[]` та `tools[]` як обмеження агентної підсистеми
- [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — Validation Gate, Activation Gate, auto-approve constraints
- [[exodus.pp.ua/architecture/КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ\|КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ]] — роль Gateway (Cloudflare Worker) як write gatekeeper
- [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]] — authority model: хто має право на write

**Від цього документа залежать:**
- [[exodus.pp.ua/backend/КОНТРАКТИ_API_V1\|КОНТРАКТИ_API_V1]] — auth headers, rate limiting policies (§0.2, §7.3)
- [[exodus.pp.ua/frontend/LOVABLE_УЗГОДЖЕННЯ_З_АРХІТЕКТУРОЮ_ВИКОНАННЯ\|LOVABLE_УЗГОДЖЕННЯ_З_АРХІТЕКТУРОЮ_ВИКОНАННЯ]] — backend authority, cosmetic vs enforcement (§4)
