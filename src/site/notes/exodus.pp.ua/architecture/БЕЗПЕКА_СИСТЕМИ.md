...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — Axiom A2 (Мутація вимагає згоди) та A5 (Gateway = єдина точка входу)
...
- [[exodus.pp.ua/architecture/RUNTIME_ARCHITECTURE_CANONICAL\|RUNTIME_ARCHITECTURE_CANONICAL]] — роль Gateway (Cloudflare Worker) як write gatekeeper
- [[exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL\|STORAGE_AUTHORITY_MODEL_CANONICAL]] — authority model: хто має право на write

**Від цього документа залежать:**
- [[exodus.pp.ua/backend/API_CONTRACTS_V1\|API_CONTRACTS_V1]] — auth headers, rate limiting policies (§0.2, §7.3)
- [[exodus.pp.ua/frontend/LOVABLE_УЗГОДЖЕННЯ_З_RUNTIME_АРХІТЕКТУРОЮ\|LOVABLE_УЗГОДЖЕННЯ_З_RUNTIME_АРХІТЕКТУРОЮ]] — backend authority, cosmetic vs enforcement (§4)
