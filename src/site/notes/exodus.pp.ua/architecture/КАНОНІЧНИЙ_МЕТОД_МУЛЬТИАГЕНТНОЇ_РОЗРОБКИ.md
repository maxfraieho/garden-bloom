---
{"tags":["domain:arch","status:canonical","format:spec","feature:execution","feature:proposal"],"created":"2026-02-21","updated":"2026-02-21","status":"canonical","domain":"architecture","tier":1,"authority":"architectural","governs":["agent_roles","development_method","architectural_authority_model"],"related":["АРХІТЕКТУРНИЙ_КОРІНЬ","КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ"],"title":"КАНОНІЧНИЙ_МЕТОД_МУЛЬТИАГЕНТНОЇ_РОЗРОБКИ","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/КАНОНІЧНИЙ_МЕТОД_МУЛЬТИАГЕНТНОЇ_РОЗРОБКИ/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- Він **не** визначає runtime-деталі виконання (вони описані в [[exodus.pp.ua/architecture/КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ\|КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ]] та пов’язаних runtime-специфікаціях).
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]]: задає верхньорівневі аксіоми та “що є системою”.
- [[exodus.pp.ua/architecture/КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ\|КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ]]: задає операційну архітектуру виконання та межі компонентів.
...
- формулює інваріанти (див. [[exodus.pp.ua/architecture/ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ\|ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ]])
...
- змінювати модель прав доступу (див. [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]])
...
**Відповідальність:**
- перевірка змін на відповідність [[exodus.pp.ua/architecture/ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ\|ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ]]
...
**Відповідальність:**
- контроль тегів згідно [[exodus.pp.ua/architecture/КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ\|КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ]]
...
### 3.2 Зв’язок з [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]]

[[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]] визначає **права читання/запису** для шарів системи.
Цей документ визначає **процесну** і **рольову** владу над еволюцією канону.

Правило узгодження:
- якщо є конфлікт між ролями в цьому документі та storage-authority правилами — **перемагає [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]]** як write-authority джерело.
...
- [[exodus.pp.ua/architecture/КАНОНІЧНИЙ_ЦИКЛ_ЗАПУСКУ\|КАНОНІЧНИЙ_ЦИКЛ_ЗАПУСКУ]] — як runtime події переходять між станами
- [[exodus.pp.ua/architecture/КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ\|КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ]] — де виникають proposals та які фази їх породжують
...
### 5.3 Relationship to [[exodus.pp.ua/architecture/ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ\|ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ]]
...
### 5.4 Relationship to [[exodus.pp.ua/architecture/КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ\|КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ]]
...
Зв’язок з [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]]:
...
Зв’язок з [[exodus.pp.ua/architecture/АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ\|АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ]]:
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]]
- [[exodus.pp.ua/architecture/КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ\|КАНОНІЧНА_АРХІТЕКТУРА_ВИКОНАННЯ]]
- [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]]
- [[exodus.pp.ua/architecture/КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ\|КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ]]
...
- [[exodus.pp.ua/architecture/ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ\|ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ]]
- [[exodus.pp.ua/architecture/КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ\|КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ]]
