---
{"title":"КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/architecture/КАНОНІЧНА_СИСТЕМА_ТЕГУВАННЯ/","dgPassFrontmatter":true,"noteIcon":""}
---
...
| `feature:storage` | [[exodus.pp.ua/architecture/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]] |
| `feature:execution` | [[exodus.pp.ua/architecture/КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ\|КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ]] |
| `feature:memory` | [[exodus.pp.ua/architecture/ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1\|ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1]] |
...
| `feature:orchestration` | [[exodus.pp.ua/architecture/АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ\|АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ]] |
...
- [[exodus.pp.ua/architecture/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — операційна норма для системи знань (мовна + структурна)

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/КАНОНІЗАЦІЯ_МОВИ\|КАНОНІЗАЦІЯ_МОВИ]] — тег-ідентифікатори є винятком EN у UA-документах
...
- [[exodus.pp.ua/architecture/ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ\|ІНВАРІАНТИ_ГРАФУ_ЗНАНЬ]] — інваріанти включають правила тегування
