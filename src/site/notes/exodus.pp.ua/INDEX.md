---
{"tags":["domain:meta","status:canonical","format:inventory"],"created":"2026-02-21","updated":"2026-02-21","title":"INDEX","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/INDEX/","dgPassFrontmatter":true,"noteIcon":""}
---
...
Карта knowledge graph: [architecture/GRAPH_MAP.md](architecture/GRAPH_MAP.md) — вузли, зв'язки, маршрути читання, аналіз стану.
...
| `architecture/MULTI_AGENT_DEVELOPMENT_METHOD_CANONICAL.md` | Мультиагентний метод розробки: ролі агентів, authority model, mutation governance |
...
| `architecture/GRAPH_MAP.md` | Doc maintainers / Architects | Повна карта knowledge graph: вузли, зв'язки, маршрути читання, аналіз стану |
| `architecture/TAGGING_SYSTEM_CANONICAL.md` | Всі | Система тегування: таксономія, governance, proposal-based QA |
| `architecture/KNOWLEDGE_GRAPH_INVARIANTS.md` | Architects / Agents | Інваріанти knowledge graph для `semantic-guard` та `graph-linter` |
