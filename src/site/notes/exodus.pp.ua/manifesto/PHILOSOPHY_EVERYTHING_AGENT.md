---
{"tags":["domain:product","status:canonical","format:philosophy"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"PHILOSOPHY_EVERYTHING_AGENT","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/manifesto/PHILOSOPHY_EVERYTHING_AGENT/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/manifesto/MANIFESTO\|MANIFESTO]] — §2 ("Все є агентом") та §3 ("Контекст — це не промпт") як ідеологічну базу

**Цей документ залежить від:**
- [[exodus.pp.ua/manifesto/MANIFESTO\|MANIFESTO]] — ідеологічний контекст та маніфестні принципи
- [[exodus.pp.ua/architecture/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — технічна реалізація агентної моделі (`_agent.md`, активація)
- [[exodus.pp.ua/architecture/RUNTIME_ARCHITECTURE_CANONICAL\|RUNTIME_ARCHITECTURE_CANONICAL]] — як агент існує у runtime (Mastra як interpreter)

**Від цього документа залежать:**
- [[exodus.pp.ua/manifesto/GLOSSARY\|GLOSSARY]] — термінологія: "агент", "папка-як-агент", "двоїстість знання–дії"
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — §1 Визначення системи: практична реалізація принципу
