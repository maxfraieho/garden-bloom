---
{"tags":["domain:api","status:canonical","format:contract"],"created":"2026-02-15","updated":"2026-02-21","tier":1,"title":"API_CONTRACTS_V1","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/backend/API_CONTRACTS_V1/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**[РІШЕННЯ]** SSE (Server-Sent Events) endpoint **відкладено на post-MVP**. MVP використовує polling (§3.1 у INBOX_AND_RUN_LIFECYCLE_V1.md).
...
2. При помилці/timeout — fallback до polling з інтервалами з §3.1 INBOX_AND_RUN_LIFECYCLE_V1.md
...
- [[exodus.pp.ua/architecture/RUNTIME_ARCHITECTURE_CANONICAL\|RUNTIME_ARCHITECTURE_CANONICAL]] — HTTP interface до Runtime Architecture компонентів
...
- [[exodus.pp.ua/architecture/INBOX_AND_RUN_LIFECYCLE_V1\|INBOX_AND_RUN_LIFECYCLE_V1]] — state machines для UI-орієнтованого lifecycle
- [[exodus.pp.ua/architecture/БЕЗПЕКА_СИСТЕМИ\|БЕЗПЕКА_СИСТЕМИ]] — auth headers, rate limiting policies (§0.2, §7.3)
- [[exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL\|STORAGE_AUTHORITY_MODEL_CANONICAL]] — authority model (хто має право на write endpoints)

**Від цього документа залежать:**
- [[exodus.pp.ua/frontend/LOVABLE_УЗГОДЖЕННЯ_З_RUNTIME_АРХІТЕКТУРОЮ\|LOVABLE_УЗГОДЖЕННЯ_З_RUNTIME_АРХІТЕКТУРОЮ]] — frontend invariants на основі цих API contracts
- [[exodus.pp.ua/frontend/FRONTEND_ALIGNMENT_DIRECTIVE_V1\|FRONTEND_ALIGNMENT_DIRECTIVE_V1]] — критичні невідповідності UI з цими contracts
