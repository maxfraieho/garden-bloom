---
{"tags":["domain:arch","status:canonical","format:spec"],"created":"2026-02-21","updated":"2026-02-21","tier":1,"title":"PROJECT_DESCRIPTION_CANONICAL","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/PROJECT_DESCRIPTION_CANONICAL/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — executive overview для всіх 7 аксіом і 5 архітектурних ролей
- [[exodus.pp.ua/manifesto/MANIFESTO\|MANIFESTO]] — реалізація ідеологічних принципів у технічній архітектурі

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/ARCHITECTURE_ROOT\|ARCHITECTURE_ROOT]] — аксіоми A1–A7 як основа архітектурних рішень
- [[exodus.pp.ua/architecture/RUNTIME_ARCHITECTURE_CANONICAL\|RUNTIME_ARCHITECTURE_CANONICAL]] — деталізація execution layer (§6–§7)
- [[exodus.pp.ua/architecture/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — визначення агентної моделі (§9)
- [[exodus.pp.ua/architecture/INBOX_ТА_PROPOSAL_АРХІТЕКТУРА\|INBOX_ТА_PROPOSAL_АРХІТЕКТУРА]] — Proposal system як safety mechanism (§11)
- [[exodus.pp.ua/architecture/STORAGE_AUTHORITY_MODEL_CANONICAL\|STORAGE_AUTHORITY_MODEL_CANONICAL]] — storage-centric authority model (§8, §12)

**Від цього документа залежать:**
- [[exodus.pp.ua/architecture/GRAPH_MAP\|GRAPH_MAP]] — використовує цей документ як Tier 1 overview вузол
