---
{"tags":["domain:frontend","status:canonical","format:guide"],"created":"2026-02-15","updated":"2026-02-21","tier":2,"title":"FRONTEND_ALIGNMENT_DIRECTIVE_V1","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/frontend/FRONTEND_ALIGNMENT_DIRECTIVE_V1/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- `docs/backend/API_CONTRACTS_V1.md` — API endpoints, error codes, headers
- `docs/architecture/PROPOSAL_SYSTEM_V1.md` — proposal state machine, approval semantics
- `docs/frontend/LOVABLE_УЗГОДЖЕННЯ_З_RUNTIME_АРХІТЕКТУРОЮ.md` — frontend invariants
...
*Canonical джерела: API_CONTRACTS_V1.md, PROPOSAL_SYSTEM_V1.md, LOVABLE_УЗГОДЖЕННЯ_З_RUNTIME_АРХІТЕКТУРОЮ.md*
