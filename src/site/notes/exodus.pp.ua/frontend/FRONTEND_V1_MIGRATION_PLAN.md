---
{"tags":["domain:frontend","status:historical","format:guide"],"created":"2026-02-21","updated":"2026-02-21","tier":2,"title":"FRONTEND_V1_MIGRATION_PLAN","dg-publish":true,"dg-metatags":null,"dg-home":null,"permalink":"/exodus.pp.ua/frontend/FRONTEND_V1_MIGRATION_PLAN/","dgPassFrontmatter":true,"noteIcon":""}
---
...
> Джерела: API_CONTRACTS_V1.md, mcpGatewayClient.ts, mcpGateway.ts
...
| **Types-first** | Спочатку типи (з API_CONTRACTS_V1.md), потім клієнт, потім UI |
...
```
Phase 1: Canonical Types Layer       ← типи з API_CONTRACTS_V1.md
...
**Що відсутнє (потрібно додати з API_CONTRACTS_V1.md):**
...
| V1 API (API_CONTRACTS_V1.md §3.3) | `'pending' \| 'approved' \| 'rejected' \| 'applied' \| 'failed'` |
...
**Відсутні endpoint groups (з API_CONTRACTS_V1.md):**
...
| **Breaking change в V1 API** | Низька | Високий | API_CONTRACTS_V1.md є канонічною; зміни тільки з оновленням документа |

### 6.2 Що НЕ міграти в MVP

| Функціонал | Причина |
|------------|---------|
| SSE Event Stream | Відкладено (Appendix B API_CONTRACTS_V1.md) |
...
- [ ] `src/types/v1/` містить усі типи з API_CONTRACTS_V1.md
