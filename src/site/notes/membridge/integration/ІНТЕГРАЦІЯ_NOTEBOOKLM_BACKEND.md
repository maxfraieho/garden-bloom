---
{"tags":["domain:api","status:canonical","format:spec","feature:execution"],"created":"2026-02-24","updated":"2026-02-24","tier":1,"title":"Інтеграція: NotebookLM Backend","dg-publish":true,"permalink":"/membridge/integration/ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Залежить від:**
- [[membridge/integration/JOB_QUEUE_ТА_ARTIFACT_MODEL\|JOB_QUEUE_ТА_ARTIFACT_MODEL]] — повна специфікація Job та Artifact моделей
- [[membridge/integration/ІНТЕГРАЦІЯ_MEMORY_BACKEND\|ІНТЕГРАЦІЯ_MEMORY_BACKEND]] — context assembly API, BM25 query protocol
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — аксіоми A3 (stateless), A5 (Gateway sole entry)

**На цей документ посилаються:**
- [[membridge/integration/RUNTIME_TOPOLOGY_NOTEBOOKLM\|RUNTIME_TOPOLOGY_NOTEBOOKLM]] — NLM Backend як вузол топології
- [[membridge/integration/DEPLOYMENT_REPLIT_АРХІТЕКТУРА\|DEPLOYMENT_REPLIT_АРХІТЕКТУРА]] — деплой цього сервісу
- [[membridge/integration/ІНТЕГРАЦІЯ_FRONTEND_LOVABLE\|ІНТЕГРАЦІЯ_FRONTEND_LOVABLE]] — відображення результатів
