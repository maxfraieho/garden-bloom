---
{"tags":["domain:frontend","status:canonical","format:spec","feature:proposal"],"created":"2026-02-24","updated":"2026-02-24","tier":1,"title":"Інтеграція: Lovable Frontend","dg-publish":true,"permalink":"/membridge/integration/ІНТЕГРАЦІЯ_FRONTEND_LOVABLE/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Backend gap:** статус Run читається з `agents/{slug}/runs/{runId}/status.json` у MinIO через Gateway. Якщо Gateway не повертає Run-список — Runs Dashboard порожній (відомий gap: [[RUNS_DASHBOARD_BACKEND_GAP_V1\|RUNS_DASHBOARD_BACKEND_GAP_V1]]).
...
- [[membridge/integration/_INDEX\|_INDEX]] — Integration Layer, індекс пакету

**Залежить від:**
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — A5 (Gateway sole entry point), A6 (Frontend is projection)
- [[exodus.pp.ua/backend/КОНТРАКТИ_API_V1\|КОНТРАКТИ_API_V1]] — визначення Gateway endpoints
- [[membridge/integration/JOB_QUEUE_ТА_ARTIFACT_MODEL\|JOB_QUEUE_ТА_ARTIFACT_MODEL]] — Job state machine та Artifact model
- [[exodus.pp.ua/operations/СИСТЕМА_PROPOSAL_V1\|СИСТЕМА_PROPOSAL_V1]] — Proposal lifecycle у Garden Seedling
- [[exodus.pp.ua/operations/INBOX_ТА_ЦИКЛ_ЗАПУСКУ_V1\|INBOX_ТА_ЦИКЛ_ЗАПУСКУ_V1]] — Inbox та Run lifecycle для UI

**На цей документ посилаються:**
- [[membridge/integration/ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND\|ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND]] — відображення результатів NLM у Frontend
- [[membridge/integration/RUNTIME_TOPOLOGY_NOTEBOOKLM\|RUNTIME_TOPOLOGY_NOTEBOOKLM]] — Lovable як external projection node
