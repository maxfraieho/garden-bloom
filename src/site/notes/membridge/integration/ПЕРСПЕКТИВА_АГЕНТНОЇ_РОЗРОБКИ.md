---
{"tags":["domain:arch","status:canonical","format:spec","feature:orchestration"],"created":"2026-02-24","updated":"2026-02-24","tier":1,"title":"Перспектива: Комплексна агентна система розробки","dg-publish":true,"permalink":"/membridge/integration/ПЕРСПЕКТИВА_АГЕНТНОЇ_РОЗРОБКИ/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Залежить від:**
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — аксіоми A1–A7 визначають границі еволюції
- [[exodus.pp.ua/architecture/core/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — MCP servers є реалізацією Agent Contract
- [[exodus.pp.ua/architecture/core/АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ\|АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ]] — Orchestration Layer залишається vendor-agnostic
- [[exodus.pp.ua/architecture/features/ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1\|ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1]] — Unified Memory базується на DiffMem

**На цей документ посилаються:**
- [[membridge/integration/ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND\|ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND]] — еволюція до MCP server
- [[membridge/integration/ІНТЕГРАЦІЯ_MEMORY_BACKEND\|ІНТЕГРАЦІЯ_MEMORY_BACKEND]] — еволюція до Unified Memory Router
- [[membridge/integration/ІНТЕГРАЦІЯ_MEMBRIDGE\|ІНТЕГРАЦІЯ_MEMBRIDGE]] — залишається інфраструктурою синхронізації
