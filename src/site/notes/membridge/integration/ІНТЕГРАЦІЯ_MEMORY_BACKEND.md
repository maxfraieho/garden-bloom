---
{"tags":["domain:storage","status:canonical","format:spec","feature:memory"],"created":"2026-02-24","updated":"2026-02-24","tier":1,"title":"Інтеграція: Memory Backend","dg-publish":true,"permalink":"/membridge/integration/ІНТЕГРАЦІЯ_MEMORY_BACKEND/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Залежить від:**
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — аксіоми A1 (storage canonical), A2 (consent), A3 (stateless), A7 (bounded memory)
- [[exodus.pp.ua/architecture/core/КОНТРАКТ_АГЕНТА_V1\|КОНТРАКТ_АГЕНТА_V1]] — визначення Layer 1 / Layer 2 та структури `_agent.md`
- [[exodus.pp.ua/architecture/features/ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1\|ПАМ_ЯТЬ_АГЕНТА_GIT_DIFFMEM_V1]] — DiffMem: канонічна модель агентної пам'яті

**На цей документ посилаються:**
- [[membridge/integration/ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND\|ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND]] — context assembly для NLM-викликів
- [[membridge/integration/ІНТЕГРАЦІЯ_MEMBRIDGE\|ІНТЕГРАЦІЯ_MEMBRIDGE]] — Membridge синхронізує SQLite; Memory Backend керує git-монорепо
- [[membridge/integration/JOB_QUEUE_ТА_ARTIFACT_MODEL\|JOB_QUEUE_ТА_ARTIFACT_MODEL]] — Phase 3 / Phase 5 Canonical Conveyor
- [[membridge/integration/RUNTIME_TOPOLOGY_NOTEBOOKLM\|RUNTIME_TOPOLOGY_NOTEBOOKLM]] — Memory Backend як вузол топології
