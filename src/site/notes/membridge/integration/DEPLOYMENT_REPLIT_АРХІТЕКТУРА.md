---
{"tags":["domain:arch","status:canonical","format:guide","feature:execution"],"created":"2026-02-24","updated":"2026-02-24","tier":1,"title":"Deployment: Replit Архітектура","dg-publish":true,"permalink":"/membridge/integration/DEPLOYMENT_REPLIT_АРХІТЕКТУРА/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Залежить від:**
- [[membridge/integration/ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND\|ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND]] — специфікація сервісу, що тут розгортається
- [[membridge/integration/RUNTIME_TOPOLOGY_NOTEBOOKLM\|RUNTIME_TOPOLOGY_NOTEBOOKLM]] — `replit-nlm` як вузол топології
- [[exodus.pp.ua/architecture/non-functional/БЕЗПЕКА_СИСТЕМИ\|БЕЗПЕКА_СИСТЕМИ]] — security principles застосовані тут

**На цей документ посилаються:**
- [[membridge/integration/ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND\|ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND]] — Recovery Playbook посилається на Replit dashboard
- [[membridge/integration/JOB_QUEUE_ТА_ARTIFACT_MODEL\|JOB_QUEUE_ТА_ARTIFACT_MODEL]] — cold start вплив на Job Queue
