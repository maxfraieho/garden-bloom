---
{"tags":["domain:storage","status:canonical","format:contract","feature:storage"],"created":"2026-02-24","updated":"2026-02-24","tier":1,"title":"Інтеграція: Membridge Control Plane","dg-publish":true,"permalink":"/membridge/integration/ІНТЕГРАЦІЯ_MEMBRIDGE/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Залежить від:**
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — A1 (MinIO canonical), A2 (consent-based mutation)
- [[exodus.pp.ua/architecture/core/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]] — матриця запису до MinIO

**На цей документ посилаються:**
- [[membridge/integration/ІНТЕГРАЦІЯ_MEMORY_BACKEND\|ІНТЕГРАЦІЯ_MEMORY_BACKEND]] — Membridge vs Memory Backend: два різних сховища
- [[membridge/integration/RUNTIME_TOPOLOGY_NOTEBOOKLM\|RUNTIME_TOPOLOGY_NOTEBOOKLM]] — Membridge як вузол топології (Alpine :8000/:8001)
- [[membridge/integration/JOB_QUEUE_ТА_ARTIFACT_MODEL\|JOB_QUEUE_ТА_ARTIFACT_MODEL]] — Artifact Store в MinIO
- [[membridge/integration/ІНТЕГРАЦІЯ_FRONTEND_LOVABLE\|ІНТЕГРАЦІЯ_FRONTEND_LOVABLE]] — Web UI через Membridge `/ui`
