---
{"tags":["domain:execution","status:canonical","format:contract","feature:execution"],"created":"2026-02-24","updated":"2026-02-24","tier":1,"title":"Job Queue та Artifact Model","dg-publish":true,"permalink":"/membridge/integration/JOB_QUEUE_ТА_ARTIFACT_MODEL/","dgPassFrontmatter":true,"noteIcon":""}
---
...
**Залежить від:**
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — A2 (consent), A3 (stateless execution), A4 (orchestration replaceable)
- [[exodus.pp.ua/architecture/core/КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ\|КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ]] — 7 фаз canonical conveyor
- [[exodus.pp.ua/architecture/core/КАНОНІЧНИЙ_ЦИКЛ_ЗАПУСКУ\|КАНОНІЧНИЙ_ЦИКЛ_ЗАПУСКУ]] — run status.json transitions
- [[exodus.pp.ua/architecture/non-functional/МОДЕЛЬ_СПОСТЕРЕЖУВАНОСТІ\|МОДЕЛЬ_СПОСТЕРЕЖУВАНОСТІ]] — audit log patterns

**На цей документ посилаються:**
- [[membridge/integration/ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND\|ІНТЕГРАЦІЯ_NOTEBOOKLM_BACKEND]] — NLM Job state machine деталі
- [[membridge/integration/ІНТЕГРАЦІЯ_MEMORY_BACKEND\|ІНТЕГРАЦІЯ_MEMORY_BACKEND]] — Phase 3 / Phase 5 в контексті пам'яті
- [[membridge/integration/ІНТЕГРАЦІЯ_FRONTEND_LOVABLE\|ІНТЕГРАЦІЯ_FRONTEND_LOVABLE]] — відображення Job states у Frontend
- [[membridge/integration/RUNTIME_TOPOLOGY_NOTEBOOKLM\|RUNTIME_TOPOLOGY_NOTEBOOKLM]] — data flow через topology
