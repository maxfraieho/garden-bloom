...
dg-publish: true
deprecated_by: "frontend/ux-plan/ВЕРИФІКАЦІЯ_ІНТЕГРАЦІЇ_API_V1.md"
---

> ⚠️ DEPRECATED. Канонічна версія: [[ВЕРИФІКАЦІЯ_ІНТЕГРАЦІЇ_API_V1]]. Цей документ є застарілою EN-копією.
