...
dg-publish: true
deprecated_by: "frontend/ux-plan/КЛАСТЕРИЗАЦІЯ_ПАПОК_ГРАФ_V1.md"
---

> ⚠️ DEPRECATED. Канонічна версія: [[КЛАСТЕРИЗАЦІЯ_ПАПОК_ГРАФ_V1]]. Цей документ є застарілою EN-копією.
