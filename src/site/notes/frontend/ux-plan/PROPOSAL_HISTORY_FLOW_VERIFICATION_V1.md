...
dg-publish: true
deprecated_by: "frontend/ux-plan/ВЕРИФІКАЦІЯ_ПОТОКУ_PROPOSAL_HISTORY_V1.md"
---

> ⚠️ DEPRECATED. Канонічна версія: [[ВЕРИФІКАЦІЯ_ПОТОКУ_PROPOSAL_HISTORY_V1]]. Цей документ є застарілою EN-копією.
