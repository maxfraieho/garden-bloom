...
dg-publish: true
deprecated_by: "frontend/ux-plan/ПРОГАЛИНИ_ДАШБОРДУ_RUNS_BACKEND_V1.md"
---

> ⚠️ DEPRECATED. Канонічна версія: [[ПРОГАЛИНИ_ДАШБОРДУ_RUNS_BACKEND_V1]]. Цей документ є застарілою EN-копією.
