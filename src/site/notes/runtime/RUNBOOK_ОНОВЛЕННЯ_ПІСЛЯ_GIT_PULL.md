...
- AGENT_REPO_URL — опціональна змінна для перевизначення репозиторію в install-script (default: bloom-core-ui.git)
...
- [[operations/СТАН_РОЗГОРТАННЯ_RUNTIME_ALPINE.md]] — топологія, сервіси, шляхи
