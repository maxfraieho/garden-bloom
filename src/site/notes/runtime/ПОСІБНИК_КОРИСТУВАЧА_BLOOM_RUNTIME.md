...
| `AGENT_REPO_URL` | Ні | URL репозиторію для install-script (default: bloom-core-ui) | `https://github.com/maxfraieho/bloom-core-ui.git` |
...
- [[operations/СТАН_РОЗГОРТАННЯ_RUNTIME_ALPINE.md]] — топологія розгортання
- [[operations/СТАН_РЕАЛІЗАЦІЇ_BACKEND_RUNTIME.md]] — деталі реалізації
- [[operations/ІНТЕГРАЦІЯ_UI_REPLIT_MEMBRIDGE.md]] — інтеграція UI
