...
created: 2026-02-25
updated: 2026-02-27
legacy_name: "СТАН_РЕАЛІЗАЦІЇ_BACKEND_RUNTIME.md"
changelog:
  - 2026-02-27 (rev 2): Protocol V1 E2E. Execution path: всі кроки LIVE. /lease → /dispatch. workerSync: online fix. Runtime Readiness: Protocol V1 dimensions додані.
title: "Стан реалізації Backend BLOOM Runtime"
dg-publish: true
---
...
This document describes the implementation state of BLOOM Runtime backend hardening, resolving critical gaps identified in [[ПРОГАЛИНИ_ТА_НАСТУПНІ_КРОКИ_RUNTIME.md]].
...
Client Request
 ...
 [4] POST /api/runtime/llm-tasks/:id/dispatch
     │   Worker selection (pickWorker)  ── ✅ LIVE (workers online, auto-sync)
     │
     ▼
 ...
 [6] membridge control plane :8000  ──── ✅ LIVE
     │
     ▼
 [7] Worker Node "alpine" (node-agent) ── ✅ LIVE (E2E verified 2026-02-27)
     │
     ▼
...
| Worker execution | ⏳ Waiting | ✅ LIVE | E2E verified 2026-02-27 |
| Async dispatch | ❌ Blocking | ✅ Fire-and-forget | agent/main.py A1 fix |
| Task heartbeat | ❌ Missing | ✅ Every 10s | agent/main.py A2 fix |
| Lease reaper | 30s interval | ✅ 15s interval | Protocol V1 §9 spec |
...
| `docs/runtime/operations/СТАН_РЕАЛІЗАЦІЇ_BACKEND_RUNTIME.md` | This document |
...
- [[СТАН_РОЗГОРТАННЯ_RUNTIME_ALPINE.md]] — baseline deployment topology
- [[ПРОГАЛИНИ_ТА_НАСТУПНІ_КРОКИ_RUNTIME.md]] — gap definitions this resolves
