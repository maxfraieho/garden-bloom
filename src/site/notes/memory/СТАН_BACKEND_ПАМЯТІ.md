...
> **⚠️ HISTORICAL SNAPSHOT (2026-02-22).** Цей документ відображає стан backend на момент завершення Phase 2. Для актуальних API contracts див. [`backend/КОНТРАКТИ_API_V1.md`](../backend/КОНТРАКТИ_API_V1.md) §10.
