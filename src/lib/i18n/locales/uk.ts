...
export const uk: Translations = {
  ...
  accessGate: {
    ...
    bloomExpansion: 'Спеціалізовані системи логічної оркестрації та операційні машини',
    runtimeSubtitle: 'Середовище виконання поведінкової логіки',
    runtimeFooter: 'Працює на BLOOM Runtime',
  },
