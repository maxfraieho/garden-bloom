...
- [[ARCHITECTURE_ROOT]] — аксіома A7 (bounded memory, git monorepo, HARD limits), частина A1 (git monorepo як source of truth)

**Цей документ залежить від:**
- [[STORAGE_AUTHORITY_MODEL_CANONICAL]] — git monorepo як storage tier (§1, Tier 1 та Tier 2)
...
- [[ORCHESTRATION_LAYER_ABSTRACTION]] — Task Definition Step 1: завантаження Layer 1
- [[EXECUTION_PIPELINE_CANONICAL]] — Phase 3 (Context Load): memory Layer 1 via Gateway
- [[AGENT_LOGIC_VERSIONING_V1]] — суміжний storage tier у тому самому git monorepo
