...
├── GRAPH_CONTRACT.md                   ← контракт execution graph
│
...
│   ├── LOVABLE_PROMPT_FRONTEND_V2.md   ← ⚠️ prompt artifact
...
| `architecture/runtime/INTEGRATION_MEMBRIDGE_EXECUTION_DISPATCH.md` | **Execution Dispatch** — task dispatch, leasing, Claude CLI proxy executor |
